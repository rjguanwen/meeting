  ...
  <div class="guide">
    ...
    <el-card shadow="never" class="g-card">
      ...
      <el-steps direction="vertical" :active="4" class="g-steps">
        ...
        <el-step title="② 进行中 ongoing" description="管理员点击「开始会议」后进入会议展示页，按组织逐条展示汇报（先小组、后部门，全屏/键盘翻页）；会议期间可由管理员在展示页为每条汇报补充讨论结论或布置新任务。" />
    ...
    <el-card shadow="never" class="g-card">
      ...
      <ul class="g-faq">
        <li><b>能看到哪些会议？</b> 只看<b>本组织直接参会</b>的会议：部门负责人不会看到仅由下属小组单独参会的会议；若部门与小组同时参会，材料页可一并查看小组汇报。</li>
        ...
        <li><b>谁可以录结论 / 新任务？</b> 仅管理员（或会议创建者），且只在会议「进行中」期间可录入 / 修改 / 删除；会议结束后结论只读。负责人与成员可查看。</li>
        <li><b>密码忘了？</b> 登录页可点「忘记密码」用<b>安全问答</b>自助重置（需事先在个人中心设置）；未设置安全问答请联系管理员重置。密码修改后其它设备需重新登录。</li>
        <li><b>怎么换头像？</b> 右上角头像 → 「个人中心」→「更换头像」：选图后拖动 / 缩放，圆形预览就是最终效果；实际上传的是裁剪后的小图，原图多大都可以选。</li>
...
const roles = [
  { role: '管理员', scope: '创建/管理会议、设置参会组织、开始/结束/归档会议、生成材料与纪要、录入讨论结论与新任务；管理组织架构、账号、会议室；查看操作日志。' },
  { role: '部门/小组负责人', scope: '为本人所属组织录入/修改汇报事项与附件（仅筹备中）；查看本组织直接参与的会议、材料与纪要（不含仅由下属小组单独参与的会议）。' },
